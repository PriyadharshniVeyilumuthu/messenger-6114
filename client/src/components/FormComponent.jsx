...
const FormComponent = (props) => {
  ...
  return (
    ...
    {props.isDesktopView && <Grid container item xs sm={5}><SideImage /> </Grid>}
    <Grid container item xs sm={7}>
        <HeaderRow clickableText={props.clickableText} labelText={props.headerLabel} onClick={props.onLabelClick}  />
    <Grid
        container
      ...
      <Box>
        <form className={classes.loginForm} onSubmit={props.handleSubmit}>
          <Grid container spacing={4} direction="column"  alignItems="flex-start">
            <Grid item>
              <Typography className={classes.welcomeText}>{props.welcomeText}</Typography>
            </Grid>
            ...
            <Grid container justifyContent="center">
              <Grid item>
                <Button type="submit" variant="contained" size="large" color="primary" className={classes.actionButton}>
                  {props.buttonText}
                </Button>
              </Grid>
            </Grid>
